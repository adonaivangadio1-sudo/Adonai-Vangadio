...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const savedTheme = localStorage.getItem("av-theme") || "system";
    ...
    function applyTheme(theme) {
        ...
        /* Automático segue o sistema do telefone */
        if (theme === "system") {

            finalTheme = systemTheme.matches
                ? "dark"
                : "light";
        ...
        /* Classes para compatibilidade com o CSS */
    ...
    /* =========================================
       AUTOMÁTICO — DETETAR ALTERAÇÃO DO IPHONE
       ========================================= */
...
/* =========================================================
   CORREÇÃO FINAL — TEMA + MENU DE TEMA
   Compatível com página principal e todas as subpáginas
   ========================================================= */

(function () {

    function iniciarTemaAV() {
        ...
        /* Evita que outros scripts interfiram */
        ...
        const opcoes = menu.querySelectorAll(".theme-option");
        ...
        const temaGuardado = localStorage.getItem("av-theme");

        if (temaGuardado) {

            aplicarTemaAV(temaGuardado);

        } else {

            aplicarTemaAV("system");

        }


        /* =========================================
           AUTOMÁTICO — DETETAR TEMA DO TELEFONE
           ========================================= */
        ...
        sistema.addEventListener("change", function () {
            ...
            const temaAtual = localStorage.getItem("av-theme");

            if (temaAtual === "system" || !temaAtual) {
    ...
    function aplicarTemaAV(tema) {
        ...
        localStorage.setItem("av-theme", tema);
        ...
        if (tema === "system") {
            ...
            const escuro = window.matchMedia(
                "(prefers-color-scheme: dark)"
            ).matches;
...
(function () {
    ...
    document.addEventListener("click", function (e) {
        ...
        if (option) {
            ...
            const tema = option.dataset.theme;
    ...
    function carregarTemaAV() {

        const tema =
            localStorage.getItem("av-theme") || "system";
    ...
    /* =====================================================
       AUTOMÁTICO — SEGUE O IPHONE / SISTEMA
    ===================================================== */
    ...
    function verificarSistemaAV() {

        const tema =
            localStorage.getItem("av-theme");

        /* Só reage ao sistema quando Automático
           estiver selecionado */
    ...
    /* =====================================================
       GARANTIR FUNCIONAMENTO DO CURRÍCULOS
    ===================================================== */
...
(function () {
    ...
    function AV_aplicarTema(tema) {

        let temaFinal = tema;

        if (tema === "system") {

            temaFinal = window.matchMedia(
                "(prefers-color-scheme: dark)"
            ).matches
                ? "dark"
                : "light";
        ...
        /* Guarda o tema no HTML */
        document.documentElement.setAttribute(
            "data-theme",
            temaFinal
        );

        /* Classes utilizadas pelo teu CSS */
        document.body.classList.toggle(
            "dark-mode",
            temaFinal === "dark"
        );
    ...
    /* =====================================================
       CURRÍCULOS
       USA EXATAMENTE AS CLASSES DA SUBPÁGINA
    ===================================================== */

    function AV_iniciarMenuTema() {
        ...
        switchers.forEach(function (switcher) {
            ...
            const botao =
                switcher.querySelector("#themeToggle");

            const menu =
                switcher.querySelector("#themeMenu");
            ...
            const opcoes =
                menu.querySelectorAll(".theme-option");
            ...
            opcoes.forEach(function (opcao) {
                ...
                opcao.onclick = function (e) {
                    ...
                    const tema =
                        opcao.getAttribute("data-theme");

                    if (!tema) return;


                    /* Guarda para TODAS as páginas */
                    localStorage.setItem(
                        "av-theme",
                        tema
                    );
    ...
    function AV_verificarSistema() {

        const tema =
            localStorage.getItem("av-theme");

        /* Só altera se AUTOMÁTICO estiver selecionado */
        if (tema === "system") {

            AV_aplicarTema("system");
        }
    }


    /* Detecta mudança do sistema */
    if (AV_sistema.addEventListener) {

        AV_sistema.addEventListener(
            "change",
            AV_verificarSistema
        );
...
/* =====================================================
   CORREÇÃO FORTE — MENU DE TEMA DA PÁGINA CURRÍCULOS
===================================================== */

(function () {

    function corrigirMenuCurriculos() {
        ...
        /* Remove eventos antigos deste reforço */
        ...
        menu.querySelectorAll(".theme-option").forEach(
            function (opcao) {
